...
public class NoteView extends View {
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
		    R.styleable.NoteView, defStyle, 0);

		mExampleString = a.getString(R.styleable.NoteView_exampleString);
		mExampleColor = a.getColor(R.styleable.NoteView_exampleColor, mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(R.styleable.NoteView_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.NoteView_exampleDrawable)) {
			mExampleDrawable = a.getDrawable(R.styleable.NoteView_exampleDrawable);
